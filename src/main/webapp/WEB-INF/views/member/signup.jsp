	...
	<div class="wrap">
		...
		<div class="gender_wrap">
			...
			<div class="gender_input_box">
				<input class="gender_input" type="radio" id="select" name="gender"
					value="M" /><label for="select">남</label> <input
					class="gender_input" type="radio" id="select2" name="gender"
					value="F" /><label for="select2">여</label>
			</div>
		...
		<div class="birth_wrap">
			<div class="birth_name">
				<i class="fa-solid fa-cake-candles"></i> 생년월일
			</div>
			<div class="birth_input_box">
				<input class="birth_input" type="date" pattern="yyyy.MM.dd"
					name="birth">
			</div>
		...
		<div class="phone_wrap">
			<div class="phone_name">
				<i class="fa-solid fa-square-phone"></i> 전화번호
			</div>
				...
				$(".join_button").click(
						function() {
							...
							if (idCheck && idckCheck && pwCheck && pwckCheck
									&& mailCheck && phoneCheck) {

								$("#join_form")
										.attr("action", "/member/signup");
								$("#join_form").submit();
							}
							return false;
						});
